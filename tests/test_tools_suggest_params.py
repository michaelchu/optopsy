...
def option_data():
    ...
    d = [
        ["SPX", "call", exp_date, quote_dates[0], 212.5, 7.35, 7.45, 0.55],
        ["SPX", "call", exp_date, quote_dates[0], 215.0, 6.00, 6.05, 0.45],
        ["SPX", "put", exp_date, quote_dates[0], 212.5, 5.70, 5.80, -0.45],
        ["SPX", "put", exp_date, quote_dates[0], 215.0, 7.10, 7.20, -0.55],
        ["SPX", "call", exp_date, quote_dates[1], 212.5, 7.45, 7.55, 0.60],
        ["SPX", "call", exp_date, quote_dates[1], 215.0, 4.96, 5.05, 0.50],
        ["SPX", "put", exp_date, quote_dates[1], 212.5, 0.0, 0.0, -0.05],
        ["SPX", "put", exp_date, quote_dates[1], 215.0, 0.0, 0.0, -0.10],
    ]
...
def wide_dte_data():
    ...
    d = [
        ["SPX", "call", exp_date, quote_date, 140.0, 1.0, 1.1, 0.10],
        ["SPX", "call", exp_date, quote_date, 150.0, 0.5, 0.6, 0.05],
        ["SPX", "put", exp_date, quote_date, 60.0, 1.0, 1.1, -0.10],
        ["SPX", "put", exp_date, quote_date, 50.0, 0.5, 0.6, -0.05],
        ["SPX", "call", exp_date_near, quote_date, 140.0, 0.1, 0.2, 0.08],
        ["SPX", "call", exp_date_near, quote_date, 150.0, 0.05, 0.1, 0.03],
        ["SPX", "put", exp_date_near, quote_date, 60.0, 0.1, 0.2, -0.08],
        ["SPX", "put", exp_date_near, quote_date, 50.0, 0.05, 0.1, -0.03],
    ]
    return pd.DataFrame(data=d, columns=cols)
