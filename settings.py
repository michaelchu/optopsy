...
ENV_VAR_ROOT = 'OPTOPSY'
DEFAULT_CONFIG_FILENAME = '~/optopsy.yml'
...
def from_file(fname=DEFAULT_CONFIG_FILENAME, testing=False):
    ...
    try:
        ...
        print(
            """ Creating this file %s You still have to create directories with data and put your data in!""" % s_conf)
        time.sleep(3)
        try:
